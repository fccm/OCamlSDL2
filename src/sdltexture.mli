...
(** {{:http://wiki.libsdl.org/moin.cgi/SDL_GetTextureBlendMode}api doc} *)
...
(** {{:http://wiki.libsdl.org/moin.fcg/SDL_GetTextureAlphaMod}api doc} *)
...
(** {{:http://wiki.libsdl.org/moin.fcg/SDL_GetTextureColorMod}api doc} *)
